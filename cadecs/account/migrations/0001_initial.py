    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_id', models.IntegerField(editable=False, unique=True)),
                ('organization_name', models.CharField(max_length=250)),
                ('organization_type', models.CharField(max_length=100)),
                ('organization_logo', models.FileField(null=True, upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(default='media/profileImage/default.png', upload_to='images/')),
